...
def register(mcp) -> None:
    ...
    async def gateway_proxy(request):
        ...
        # The coordinator owns the whole chain --
        # Unified -> Preview -> Gate -> freshness -> Mutation Shadow
        # -> Real Injection -- and returns the body to forward. When
        # the master flag is OFF, or on any deny / exception, it
        # returns forward_body unchanged. The gateway never decides
        # the ordering, freshness or injection eligibility itself.
